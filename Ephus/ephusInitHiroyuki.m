...
xsgStartDirectory = 'D:\Data\';                 % Default root directory used by XSG program for saving data files. NOTE: This value can be overridden by a saved XSG configuration, which is often desirable.
