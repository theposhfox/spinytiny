...
for a = 1:length(ROIs)
    if ~isempty(ROIs{a})
        ...
        if glovar.NewSpineAnalysis
            ...
            glovar.ROI(a) = rectangle('Position', ROIs{a}, 'EdgeColor', [0.2 0.4 0.9], 'Curvature', [1 1],'Tag', ['ROI', num2str(ROInum)], 'ButtonDownFcn', {@DragROI, ROInum, 'HomeWindow'}, 'Linewidth', 1, 'UIContextMenu', c); 
        else
