...
uicontrol('Parent', d, 'Style', 'pushbutton', 'Position', [dlgwdth/2-55 30 50 25], 'String', 'Yes', 'Callback', @DlgChoice)
uicontrol('Parent', d, 'Style', 'pushbutton', 'Position', [dlgwdth/2+5 30 50 25], 'String', 'No', 'Callback', @DlgChoice)
uiwait(d)
choice = get(d, 'UserData');
delete(d);
